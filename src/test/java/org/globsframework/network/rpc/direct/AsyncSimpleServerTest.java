...
public class AsyncSimpleServerTest {
    ...
    public void testName() throws IOException {
        ...
        Assertions.assertEquals(1, response.get(DummyObject.id, 0));
        Assertions.assertEquals("test " + (count - 1), response.get(DummyObject.name));
